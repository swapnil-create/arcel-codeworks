...
| D05 | Identity, storage permissions, canonical data model, ledger, preview deploy pipeline | Coder + Standards | in progress | Foundation slice started: honesty/auth-required UX, PR CI scaffold, Conversation/Message/Run/UsageEntry stubs. Evidence: `app.js` banners · `lib/generation-errors.js` · `.github/workflows/ci.yml` · [docs/PREVIEW-CI.md](./docs/PREVIEW-CI.md) · [docs/data-model/README.md](./docs/data-model/README.md). Polish: Figma CTAs on gate banners + reserved `quota-exhausted` catalog. **Not done** — no IdP, no live DB, no ledger execution, protected preview still needs owner GitHub↔Vercel + branch protection. |
...
|---|---|---|
| Coder | D04 plan/harness via [PR #6](https://github.com/swapnil-create/arcel-codeworks/pull/6); private live streaming pass recorded in [D04-LIVE-RESULTS.md](./docs/D04-LIVE-RESULTS.md) ([PR #9](https://github.com/swapnil-create/arcel-codeworks/pull/9)). D04 still in progress — tools/search/image/voice unsupported. D05 foundation in progress on [PR #8](https://github.com/swapnil-create/arcel-codeworks/pull/8) (honesty UX, CI scaffold, schema stubs). Remaining D05: real auth, live DB, ledger. Architecture notes merged ([PR #1](https://github.com/swapnil-create/arcel-codeworks/pull/1)). | in progress |
