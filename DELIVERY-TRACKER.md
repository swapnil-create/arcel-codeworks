...
| D05 | Identity, storage permissions, canonical data model, ledger, preview deploy pipeline | Coder + Standards | in progress | Foundation slice **landed on main** via merged [PR #8](https://github.com/swapnil-create/arcel-codeworks/pull/8) (merge `f0f59d6`, tip `929388e`): honesty/auth-required UX, PR CI scaffold, Conversation/Message/Run/UsageEntry stubs. Evidence: `app.js` banners · `lib/generation-errors.js` · `.github/workflows/ci.yml` · [docs/PREVIEW-CI.md](./docs/PREVIEW-CI.md) · [docs/data-model/README.md](./docs/data-model/README.md). Polish: Figma CTAs on gate banners + reserved `quota-exhausted` catalog. **Not done** — no IdP, no live DB, no ledger execution, protected preview still needs owner GitHub↔Vercel + branch protection. |
...
|---|---|---|---|---|
| WP-01 | Architecture, schemas, env, auth, CI | R0 decisions | in progress | Architecture + §20 gate docs **merged on main**: [WP-01-ARCHITECTURE.md](./docs/WP-01-ARCHITECTURE.md) via [PR #1](https://github.com/swapnil-create/arcel-codeworks/pull/1) (`ac69866`); [WP-01-SECURITY-NFR-GATE.md](./docs/WP-01-SECURITY-NFR-GATE.md) via [PR #3](https://github.com/swapnil-create/arcel-codeworks/pull/3) (merge `7ba380e`, tip `b33991b`). D05 foundation **merged on main** via [PR #8](https://github.com/swapnil-create/arcel-codeworks/pull/8) (`f0f59d6`): honesty UX + PR CI scaffold + schema stubs ([docs/PREVIEW-CI.md](./docs/PREVIEW-CI.md), [docs/data-model/README.md](./docs/data-model/README.md)). Still **not done** — migration tests against a real DB + protected preview Fail; R0 blockers SEC-01, REL-03, OPS-01 remain. |
...
|---|---|---|
| Coder | D04 plan/harness via [PR #6](https://github.com/swapnil-create/arcel-codeworks/pull/6); private live streaming pass recorded in [D04-LIVE-RESULTS.md](./docs/D04-LIVE-RESULTS.md) ([PR #9](https://github.com/swapnil-create/arcel-codeworks/pull/9)). D04 still in progress — tools/search/image/voice unsupported after PR #9. D05 foundation **merged** via [PR #8](https://github.com/swapnil-create/arcel-codeworks/pull/8) (`f0f59d6`: honesty UX, CI scaffold, schema stubs). Remaining D05: real auth, live DB, ledger. Architecture notes merged ([PR #1](https://github.com/swapnil-create/arcel-codeworks/pull/1)). | in progress |
...
| 2026-09-14 16:00 | [PR #8](https://github.com/swapnil-create/arcel-codeworks/pull/8) merged to main (`f0f59d6`) — D05 foundation (honesty UX + CI scaffold + data-model stubs) on main; D05 and WP-01 remain in progress / not done. |
